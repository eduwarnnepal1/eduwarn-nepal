      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">
            {t({ en: "Welcome Back", ne: "फेरि स्वागत छ" })}
          </CardTitle>
          <CardDescription className="text-center">
            {t({ en: "Sign in to your EduWarn Nepal account", ne: "आफ्नो EduWarn Nepal खातामा साइन इन गर्नुहोस्" })}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={loading}>
              {loading ? t({ en: "Signing in...", ne: "साइन इन गर्दै..." }) : t({ en: "Sign In", ne: "साइन इन गर्नुहोस्" })}
            </Button>
          </form>
        </CardContent>
        <CardFooter className="flex flex-col space-y-2">
          <div className="text-sm text-center text-muted-foreground">
            {t({ en: "Don't have an account?", ne: "खाता छैन?" })}{" "}
            <Link href="/auth/register" className="text-primary hover:underline font-medium">
              {t({ en: "Sign up", ne: "साइन अप गर्नुहोस्" })}
            </Link>
          </div>
        </CardFooter>
      </Card>
