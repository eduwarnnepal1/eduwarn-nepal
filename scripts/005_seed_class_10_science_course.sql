...
-- Get the course ID
WITH course_data AS (
  SELECT id FROM public.courses WHERE title_en = 'Class 10 Science' LIMIT 1
)
...
SELECT
  ...
  module_data.title_en,
  module_data.title_ne,
  module_data.description_en,
  module_data.description_ne,
  module_data.module_number,
  NOW(),
  NOW()
FROM (
  VALUES
    ('Heat and Temperature', 'ताप र तापमान', 'Understanding thermal energy and temperature concepts', 'ताप र तापमान अवधारणा बुझ्न', 1),
    ('Sound', 'ध्वनि', 'Properties and behavior of sound waves', 'ध्वनि तरंगहरूको गुण र व्यवहार', 2),
    ('Light and Optics', 'प्रकाश र प्रकाशिकी', 'Reflection, refraction, and optics fundamentals', 'परावर्तन, अपवर्तन र प्रकाशिकी मूलभूत', 3),
    ('Electricity', 'विद्युत', 'Current, resistance, and electrical circuits', 'विद्युत प्रवाह, प्रतिरोध र विद्युत परिपथ', 4),
    ('Magnetism', 'चुम्बकत्व', 'Magnetic fields and electromagnetic induction', 'चुम्बकीय क्षेत्र र विद्युतचुम्बकीय प्रेरण', 5),
    ('Matter and Atoms', 'पदार्थ र परमाणु', 'Structure of atoms and periodic table', 'परमाणुको संरचना र आवर्त सारणी', 6),
    ('Chemical Reactions', 'रासायनिक प्रतिक्रिया', 'Types of chemical reactions and equations', 'रासायनिक प्रतिक्रियाका प्रकार र समीकरण', 7),
    ('Acids, Bases, and Salts', 'अम्ल, क्षार र लवण', 'Properties and reactions of acids, bases and salts', 'अम्ल, क्षार र लवणका गुण र प्रतिक्रिया', 8),
    ('Carbon and Its Compounds', 'कार्बन र यसका यौगिकहरु', 'Organic chemistry fundamentals', 'जैविक रसायन विज्ञान मूलभूत', 9),
    ('Cell Biology', 'कोशिका जीवविज्ञान', 'Cell structure and functions', 'कोशिकाको संरचना र कार्य', 10),
    ('Reproduction', 'प्रजनन', 'Sexual and asexual reproduction', 'लैंगिक र अलैंगिक प्रजनन', 11),
    ('Heredity and Evolution', 'आनुवंशिकता र विकास', 'Mendelian genetics and evolution', 'मेन्डेलीय आनुवंशिकता र विकास', 12),
    ('Ecology', 'पारिस्थितिकी', 'Ecosystems and food chains', 'पारिस्थितिकी तंत्र र खाद्य श्रृंखला', 13),
    ('Human Body Systems', 'मानव शरीर प्रणाली', 'Anatomy and physiology', 'शरीरविज्ञान र अंगविन्यास', 14),
    ('Nutrition and Health', 'पोषण र स्वास्थ्य', 'Balanced diet and diseases', 'संतुलित आहार र रोग', 15),
    ('Astronomy', 'खगोल विज्ञान', 'Solar system and celestial bodies', 'सौर मण्डल र आकाशीय पिण्ड', 16),
    ('Energy and Resources', 'ऊर्जा र संसाधनहरु', 'Renewable and non-renewable resources', 'नवीकरणीय र गैर-नवीकरणीय संसाधन', 17)
) AS module_data(title_en, title_ne, description_en, description_ne, module_number)
ON CONFLICT DO NOTHING;
...
WHERE c.title_en = 'Class 10 Science' AND m.module_number = 1
LIMIT 1
ON CONFLICT DO NOTHING;
...
SELECT
  l.id,
  mcq_data.question_en,
  mcq_data.question_ne,
  mcq_data.option_a_en,
  mcq_data.option_a_ne,
  mcq_data.option_b_en,
  mcq_data.option_b_ne,
  mcq_data.option_c_en,
  mcq_data.option_c_ne,
  mcq_data.option_d_en,
  mcq_data.option_d_ne,
  mcq_data.correct_answer,
  mcq_data.explanation_en,
  mcq_data.explanation_ne,
  mcq_data.mcq_type
FROM public.lessons l
CROSS JOIN (
  VALUES
  ...
  question_en, question_ne, option_a_en, option_a_ne, option_b_en, option_b_ne,
  option_c_en, option_c_ne, option_d_en, option_d_ne, correct_answer,
  explanation_en, explanation_ne, mcq_type
)
WHERE l.title_en = 'Tips for SEE'
ON CONFLICT DO NOTHING;
